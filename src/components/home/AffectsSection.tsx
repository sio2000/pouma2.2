...
type Affect = { text: string; image: string; alt: string; position?: string };
          ...
          {items.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative h-[17.5rem] overflow-hidden rounded-xl shadow-[0_18px_44px_rgba(36,22,64,0.16)] ring-1 ring-[color:var(--home-line)]">
                  <Image
                    src={item.image}
                    alt={item.alt}
                    fill
